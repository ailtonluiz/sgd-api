...
import com.ailtonluiz.sgdapi.domain.exception.EntityNotFoundException;
import com.ailtonluiz.sgdapi.domain.exception.BusinessException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleEntityInUse(EntityInUseException ex, WebRequest request) {
        ...
        ProblemType problemType = ProblemType.ENTITY_IN_US;
        String detail = ex.getMessage();
