...
(
    ...
    number     VARCHAR(5)   NULL NOT NULL,
    ...
    client_group_id BIGINT  NULL NOT NULL,
    PRIMARY KEY (id),
    INDEX fk_address_city (city_id ASC) VISIBLE,
    CONSTRAINT fk_address_city_client FOREIGN KEY (city_id) REFERENCES city (id),
    INDEX fk_client_group (client_group_id ASC) VISIBLE,
